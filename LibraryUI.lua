...
local Signal = loadstring(game:HttpGet("https://raw.githubusercontent.com/bobbbb-b/nyulabutlowbudget/main/Signal"))()
...
local cfglocation = "lion/configs/"
if not isfolder("lion") then
    makefolder("lion")
end
if not isfolder("lion/configs") then
    makefolder("lion/configs")
end
if not isfolder("lion/luas") then
    makefolder("lion/luas")
end
				...
				elseif type(Elements) == "table" then
				    for i,v in pairs(Elements) do
				        if type(v) == "table" then
				            ...
				            v.Toggle = v.Toggle
				            v.FixedBylion = true -- holy shit this took a while to do
				            v.Text = v.Text
				            --[[
...
function library:OnlineDeepCopy(original)
	...
	function menu:Tab(text)
		...
		Left.ScrollBarImageColor3 = Color3.fromRGB(119, 0, 0)
		...
		Right.ScrollBarImageColor3 = Color3.fromRGB(119, 0, 0)
				...
				function tab:Element(type, text, data, callback)
					...
					elseif type == "ToggleKeybind" then
						...
						do
							...
							Toggle.Text = "Toggle"
							Toggle.TextColor3 = COL3RGB(119, 0, 0)
					...
					elseif type == "Toggle" then
						...
						local function update()
							if Element.value.Toggle then
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(119, 0, 0)})
								library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(255, 255, 255)})
							else
					...
					elseif type == "ToggleColor" then
						...
						local function update()
							if Element.value.Toggle then
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(119, 0, 0)})
